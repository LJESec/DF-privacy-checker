...
f= open("pipe_entfiles_raw_BE_transformed.csv","w+")

f3= open("pipe_entfiles_test_data_transformed.csv","w+")
...
with open('pipe_entfiles_raw_BE.csv', 'r') as read_obj:
...
###
# read csv file as a list of lists
with open('pipe_entfiles_test_data.csv', 'r') as read_objB:
    # pass the file object to reader() to get the reader object
...
######################
##  
## Http-Server not used in integration pipeline
## 
## PORT = 8000
## 
